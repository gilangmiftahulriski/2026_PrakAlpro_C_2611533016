...
sim_c_3016 = input("Apakah Anda Sudah Punya SIM C (y/t): ")[0].strip().lower()
...
if jumlah_tiket_3016 <= 0:
    ...
    exit()
member_3016 = input("Apakah Anda member? (y/t)       : ")[0].strip().lower()
promo_3016 = input("Apakah kode promo valid? (y/t)  : ")[0].strip().lower()
...
match paket_3016:
    ...
    case 5: # Wahana All-Access VIP
        if umur_3016 >= 17 and sim_c_3016 == 'y':
            ...
            print("Anda belum cukup umur dan tidak boleh bawa motor ATV.")
        harga_satuan_3016 = 220000
    case _: 
        print("Paket wahana tidak valid!")
        exit()

diskon_3016 = 0
if harga_satuan_3016 * jumlah_tiket_3016 >= 200000:
    diskon_3016 += 10
if member_3016 in ["y","ya"]:
    diskon_3016 += 5
if promo_3016 in ["y","ya"]:
    diskon_3016 += 15
if jumlah_tiket_3016 >= 5:
    diskon_3016 += 5

nominal_3016 = harga_satuan_3016 * jumlah_tiket_3016
nominal_diskon_3016 = nominal_3016 * (diskon_3016 / 100)
total_bayar_3016 = nominal_3016 - nominal_diskon_3016
print("\n--- Rincian Pembayaran ---")
print(f"Subtotal Belanja : Rp {nominal_3016:,}")
if nominal_3016 > 300000: 
    print("Selamat! Anda berhak mendapatkan Souvenir Gratis.")
print(f"Total Diskon     : {diskon_3016}% (Rp {int(nominal_diskon_3016):,})")
print(f"Total Bayar      : Rp {int(total_bayar_3016):,}")
